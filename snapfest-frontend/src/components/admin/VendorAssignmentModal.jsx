          ...
          <div className="w-full lg:w-1/3 p-6 border-b lg:border-b-0 lg:border-r overflow-y-auto">
            ...
            {booking ? (
              <div className="space-y-3 text-sm text-gray-700">
                ...
                <p className="flex items-center"><Info className="w-4 h-4 mr-2 text-primary-500" /> <strong>Status:</strong> <Badge className={`ml-2 ${getStatusBadgeColor(booking.vendorStatus || 'Not Assigned')}`}>{booking.vendorStatus || 'Not Assigned'}</Badge></p>
